                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                <strong class="dc-logo"><a href="<?= base_url() ?>"><img src="<?= base_url('assets') ?>/images/logo.png" alt="company logo here"></a></strong>
                                            ...
                                            <div class="dc-loginformhold">
                                                ...
                                                <form class="dc-formtheme dc-loginform do-login-form">
                                                    ...
                                                    <div class="dc-loginfooterinfo">
                                                        <a href="<?= base_url() ?>" class="dc-forgot-password">Forgot password?</a>
                                            ...
                                            <div class="dc-select">
                                                <select class="chosen-select locations" data-placeholder="Country" name="locations">
                                                    <?php foreach ($dropdown as $row): ?>
                                                        <option value="<?php echo $row->iso; ?>"><?php echo $row->nicename; ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                            </div>
                                        </div>
                            ...
                            <div class="dc-registerformhold">
                                <div class="dc-registerformmain">
                                    ...
                                    <div class="dc-joinforms">
                                        ...
                                        <form class="dc-formtheme dc-formregister" action="<?= base_url('user_registration1') ?>" method="POST">
                                            <fieldset class="dc-registerformgroup">
                                                <div class="form-group dc-form-group-dropdown form-group-half">
                                                    <span class="dc-select">
                                                        <select name="gender">
                                                            <option value="male" value=" <?php if($gender == "male") {echo "selected";} ?> ">Mr.</option>
                                                            <option value="female" value=" <?php if($gender == "female") {echo "selected";} ?> ">Mrs</option>
                                                        </select>
                                                    </span>
                                                ...
                                                <div class="form-group form-group-half">
                                                    <input type="password" name="password1" class="form-control" placeholder="Retype Password*" min="6" required>
                                                </div>
                                            </fieldset>
                                            <fieldset class="dc-formregisterstart">
                                                ...
                                                <ul class="dc-startoption">
                                                    <li>
                                                        <span class="dc-radio">
                                                            <input id="dc-hospital" type="radio" name="typejoin" value="hospital" checked="">
                                                            <label for="dc-hospital">Hospital</label>
                                                        </span>
                                                    </li>
                                                    <li>
                                                        <span class="dc-radio">
                                                            <input id="dc-doctor" type="radio" name="typejoin" value="doctor">
                                                            <label for="dc-doctor">Doctor</label>
                                                        </span>
                                                    </li>
                                                    <li>
                                                        <span class="dc-radio">
                                                            <input id="dc-regularuser" type="radio" name="typejoin" value="regular_user">
                                                ...
                                                <?php if ($this->session->flashdata('registration_failed')) { ?>
                                                    <fieldset class="dc-formregisterstart">
                                                        <div class="alert alert-danger" role="alert">
                                                            <?= $this->session->flashdata('registration_failed'); ?>
                                                        </div></fieldset>
                                                <?php } ?>
                                                <?php if ($this->session->flashdata('email_exist')) { ?>
                                                    <fieldset class="dc-formregisterstart">
                                                        <div class="alert alert-danger" role="alert">
                                                            <?= $this->session->flashdata('email_exist') ?>
                                                        </div></fieldset>
                                                <?php } ?>
                                                ...
                                                <div class="form-group">
                                                    <button class="dc-btn">Start Now</button>
                                                </div>
                                                <fieldset>
                                                    </form>
                                                    </div>

                                                    <span>Already Have an Account? <a href="<?= base_url('login') ?>">Login Now</a></span>
                                                    </div>
