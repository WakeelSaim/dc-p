							...
							<div class="dc-registerformhold">
								<div class="dc-registerformmain">
									...
									<div class="dc-joinforms">
										<form class="dc-formtheme dc-formregister" method="post" action="<?= base_url('dashboard') ?>" >
											...
											<?php if ($this->session->flashdata('email_error')) { ?>
                                				...
                                				<?php if ($this->session->flashdata('wrong_login')) { ?>
                                    					<div class="alert alert-danger" role="alert">
                                        					<?= $this -> session -> flashdata('wrong_login') ?>
                                    					</div>
                                				<?php } ?>
                                				...
                                				<?php if ($this->session->flashdata('not_verified')) { ?>
                                    					<div class="alert alert-danger" role="alert">
                                        					<?php echo $this -> session -> flashdata('not_verified') ?>
                                    					</div>
                                				<?php } ?>
											...
											<div class="dc-checkboxholder">
													<button class="dc-btn">Login</button>
								...
								<div class="dc-registerformfooter">
									<span>Create an account <a href="<?= base_url('user_registration') ?>">Create account</a></span>
								</div>
							</div>
						</div>
					</div>
