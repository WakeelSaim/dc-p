        ...
        <div id="dc-wrapper" class="dc-wrapper dc-haslayout">
			...
			<div class="dc-navigationarea">
				<div class="container">
					<div class="row">
						<div class="col-12 col-sm-12 col-md-12 col-lg-12">
							<strong class="dc-logo"><a href="index.html"><img src="<?= base_url('assets') ?>/images/logo.png" alt="Flypav"></a></strong>
							<div class="dc-rightarea">
								<nav id="dc-nav" class="dc-nav navbar-expand-lg">
									...
									<div class="collapse navbar-collapse dc-navigation" id="navbarNav">
										<ul class="navbar-nav">
											...
											<li class="menu-item-has-children page_item_has_children dc-navactive"><span class="dc-dropdowarrow"><i class="lnr lnr-chevron-right"></i></span>
												<a href="javascript:void(0);">Pages</a>
												<ul class="sub-menu">
													<li class="menu-item-has-children page_item_has_children dc-notificationicon"><span class="dc-dropdowarrow"><i class="lnr lnr-chevron-right"></i></span><span class="dc-dropdowarrow"><i class="lnr lnr-chevron-right"></i></span>
														<a href="javascript:void(0);">Home</a>
														<ul class="sub-menu menu-item-moved" style="left: auto; right: 100%;">
															<li><a href="index.html">Home Version 1</a></li>
															<li class="dc-newnoti"><a href="indexv2.html">Home Version 2</a></li>
														</ul>
													</li>
													<li class="menu-item-has-children page_item_has_children"><span class="dc-dropdowarrow"><i class="lnr lnr-chevron-right"></i></span><span class="dc-dropdowarrow"><i class="lnr lnr-chevron-right"></i></span>
								...
								<div class="dc-loginarea">
									<div class="dc-loginoption">
										...
										<div class="dc-loginformhold">
											...
											<form class="dc-formtheme dc-loginform do-login-form" method="post" action="<?= base_url('dashboard') ?>">
												<fieldset>
													...
													<div class="dc-logininfo">
														...
														<button class="dc-btn do-login-button">Login</button>
													</div>
												</fieldset>
												<div class="dc-loginfooterinfo">
													<a href="javascript:;" class="dc-forgot-password">Forgot password?</a>
													<a href="<?= base_url('user_registration') ?>">Create account</a>
												</div>
											</form>
									...
									<a href="<?= base_url('user_registration') ?>" class="dc-btn">Join Now</a>
								</div>
							</div>
						</div>
					</div>
            ...
            <div class="dc-homeslidervtwo dc-haslayout">
                <div id="dc-bannervtwo" class="dc-bannervtwo owl-carousel">
                    <div class="item">
                        <figure class="dc-silderimg"><img src="<?= base_url('assets') ?>/images/slider/img-01.jpg" alt="img description"></figure>
                    </div>
                    <div class="item">
                        <figure class="dc-silderimg"><img src="<?= base_url('assets') ?>/images/slider/img-02.jpg" alt="img description"></figure>
                    </div>
                    <div class="item">
                        <figure class="dc-silderimg"><img src="<?= base_url('assets') ?>/images/slider/img-03.jpg" alt="img description"></figure>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-12 col-sm-12 col-md-12 col-lg-6">
                                <div class="dc-medicalfacility">
                                    <div class="dc-title">
                                        <h2><em>Emergency?</em><span> Find Nearest </span>Medical Facility</h2>
                                    </div>
                                    <form class="dc-formtheme dc-medicalform">
                                        <fieldset>
                                            <div class="form-group">
                                                <input type="text" name="search" value="" class="form-control" placeholder="Search doctors, clinics, hospitals, etc." required="">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group dc-btnarea">
                                                ...
                                                <a href="javascript:void(0);" class="dc-btn">search Now</a>
                                            </div>
                                        </fieldset>
                                    </form>
                                </div>
                            ...
                            <div class="d-none col-md-6 d-lg-block">
                                <figure class="dc-slidercontentimg">
                                    <img src="<?= base_url('assets') ?>/images/slider/img-05.png" alt="img desciption">
                                </figure>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="dc-prohelpholder">
                                    <div class="dc-sectionhead dc-sectionheadvtwo">
                                        <div class="dc-sectiontitle">
                                            <h2>Ask Private Query &amp;<span>Get Professional Help!</span></h2>
                                        </div>
                                        <div class="dc-description">
                                            <p>Lorem ipsum dolor amet consectetur adipisicing eliteiuim sete eiuod tempor incididunt ut labore etnalom dolore magna aliqua.</p>
                                        </div>
                                    </div>
                                    <form class="dc-formtheme dc-formhelp">
                                        <fieldset>
                                            <div class="form-group">
                                                <input type="text" name="search" value="" class="form-control" placeholder="Title Your Query*" required="">
                                            </div>
                                            <div class="form-group">
                                                <textarea class="form-control" placeholder="Type Your Query*"></textarea>
                                            </div>
                                            <div class="form-group dc-btnarea">
                                                <a href="javascript:void(0);" class="dc-btn" data-toggle="modal" data-target="#freequery">Ask Free Query</a>
                                            </div>
                                        </fieldset>
                                    </form>
                                </div>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                                <div class="dc-feedbackholder">
                                    <div class="dc-sectionhead">
                                        <div class="dc-sectiontitle">
                                            <h2><span>Frequently Asked Questions</span> Professional Feedback
                                            </h2>
                                        </div>
                                    </div>
                                    <div class="dc-feedbackcontent-holder">
                                        <figure class="dc-feedbackimg dc-color1">
                                            <img src="<?= base_url('assets') ?>/images/feedback/img-01.png" alt="img description">
                                        </figure>
                                        <div class="dc-feedbackcontent">
                                            <div class="dc-title">
                                                <h3><a href="javascript:void(0);">Pregnancy Safety Tips</a></h3>
                                                <a href="javascript:void(0);">Gynaecology</a>
                                                <span><i class="ti-comments"></i> No Answers</span>
                                            </div>
                                            <div class="dc-description">
                                                <p>Amet consectetur adipisicing eliteiuim sete eiuod tempor incntion ureas etnalom dolore magna aliqua udiminimate?</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="dc-feedbackcontent-holder">
                                        <figure class="dc-feedbackimg dc-color2">
                                            <img src="<?= base_url('assets') ?>/images/feedback/img-02.png" alt="img description">
                                        </figure>
                                        <div class="dc-feedbackcontent">
                                            <div class="dc-title">
                                                <h3><a href="javascript:void(0);">Root Canal</a></h3>
                                                <a href="javascript:void(0);">Dentistry</a>
                                                <span><i class="ti-comments"></i> 506 Answers</span>
                                            </div>
                                            <div class="dc-description">
                                                <p>Soniate consectetur adipisicing eliteiuim sete eiuod tempor?</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="dc-feedbackcontent-holder">
                                        <figure class="dc-feedbackimg dc-color3">
                                            <img src="<?= base_url('assets') ?>/images/feedback/img-03.png" alt="img description">
                                        </figure>
                                        <div class="dc-feedbackcontent">
                                            <div class="dc-title">
                                                <h3><a href="javascript:void(0);">Cracking Joints</a></h3>
                                                <a href="javascript:void(0);">Orthopedic</a>
                                                <span><i class="ti-comments"></i> 1208 Answers</span>
                                            </div>
                                            <div class="dc-description">
                                                <p>Adipisicing eliteiuim sete eiuod temp indidunt utoreas etnalomise olore magna aliqua udiminimate veniam quistani norud etionate ullamca aiso laboris nisiation aliquip commodo?</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="dc-btnarea">
                                        <hr>
                                        <a href="javascript:void(0);" class="dc-btn">View All</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-12 col-sm-6 col-md-4 col-lg-4">
                                    <div class="dc-workdetails">
                                        <div class="dc-workdetail">
                                            <figure>
                                                <img src="<?= base_url('assets') ?>/images/work-icon/img-01.png" alt="img description">
                                            </figure>
                                        </div>
                                        <div class="dc-title">
                                ...
                                <div class="col-12 col-sm-6 col-md-4 col-lg-4">
                                    <div class="dc-workdetails dc-workdetails-border">
                                        <div class="dc-workdetail">
                                            <figure>
                                                <img src="<?= base_url('assets') ?>/images/work-icon/img-02.png" alt="img description">
                                            </figure>
                                        </div>
                                        <div class="dc-title">
                                ...
                                <div class="col-12 col-sm-6 col-md-4 col-lg-4">
                                    <div class="dc-workdetails dc-workdetails-bordertwo">
                                        <div class="dc-workdetail">
                                            <figure>
                                                <img src="<?= base_url('assets') ?>/images/work-icon/img-03.png" alt="img description">
                                            </figure>
                                        </div>
                                        <div class="dc-title">
                                ...
                                <div class="row">
                                    <div class="dc-ratedecontent dc-bgcolor">
                                        <figure class="dc-neurosurgeons-img">
                                            <img src="<?= base_url('assets') ?>/images/doc-imgs/img-02.png" alt="img description">
                                        </figure>
                                        <div class="dc-sectionhead dc-sectionheadvtwo dc-text-center">
                                            <div class="dc-sectiontitle">
                                                <h2>Our Top Rated<span>Neurosurgeons</span></h2>
                                            </div>
                                            <div class="dc-description">
                                                <p>Lorem ipsum dolor amet consectetur adipisicing eliuim sete eiusmod tempor incididunt.</p>
                                            </div>
                                        </div>
                                        <div class="dc-btnarea">
                                            <a href="javascript:void(0);" class="dc-btn">View All</a>
                                ...
                                <div class="row">
                                    <div id="dc-docpostslider" class="dc-docpostslider owl-carousel">
                                        <div class="item">
                                            <div class="dc-docpostholder">
                                                <figure class="dc-docpostimg">
                                                    <img src="<?= base_url('assets') ?>/images/doctors/img-01.jpg" alt="img description">
                                                    <figcaption>
                                        ...
                                        <div class="item">
                                            <div class="dc-docpostholder">
                                                <figure class="dc-docpostimg">
                                                    <img src="<?= base_url('assets') ?>/images/doctors/img-02.jpg" alt="img description">
                                                    <figcaption>
                                                        <span class="dc-featuredtag"><i class="fa fa-bolt"></i></span>
                                                    </figcaption>
                                                </figure>
                                        ...
                                        <div class="item">
                                            <div class="dc-docpostholder">
                                                <figure class="dc-docpostimg">
                                                    <img src="<?= base_url('assets') ?>/images/doctors/img-04.jpg" alt="img description">
                                                    <figcaption>
                                                        <span class="dc-featuredtag"><i class="fa fa-bolt"></i></span>
                                                    </figcaption>
                                                </figure>
                                        ...
                                        <div class="item">
                                            <div class="dc-docpostholder">
                                                <figure class="dc-docpostimg">
                                                    <img src="<?= base_url('assets') ?>/images/doctors/img-03.jpg" alt="img description">
                                                    <figcaption>
                                                        <span class="dc-featuredtag"><i class="fa fa-bolt"></i></span>
                                                    </figcaption>
                                                </figure>
                                        ...
                                        <div class="item">
                                            <div class="dc-docpostholder">
                                                <figure class="dc-docpostimg">
                                                    <img src="<?= base_url('assets') ?>/images/doctors/img-05.jpg" alt="img description">
                                                    <figcaption>
                                                        <span class="dc-featuredtag"><i class="fa fa-bolt"></i></span>
                                                    </figcaption>
                                                </figure>
                        ...
                        <div class="row">
                            <div class="col-12 col-sm-12 col-md-12 col-lg-6">
                                <div class="dc-appbgimg">
                                    <figure>
                                        <img src="<?= base_url('assets') ?>/images/app-imgs/img-01.png" alt="img description">
                                    </figure>
                                </div>
                            </div>
                            <div class="col-12 col-sm-12 col-md-12 col-lg-6 justify-content-center align-self-center">
                                <div class="dc-appcontent">
                                    ...
                                    <ul class="dc-appicons">
                                        <li><a href="javascript:void(0);"><img src="<?= base_url('assets') ?>/images/app-imgs/img-03.png" alt="img description"></a></li>
                                        <li><a href="javascript:void(0);"><img src="<?= base_url('assets') ?>/images/app-imgs/img-02.png" alt="img description"></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row justify-content-center align-self-center">
                            ...
                            <div class="dc-articlesholder">
                                <div class="col-12 col-sm-12 col-md-6 col-lg-4 float-left">
                                    <div class="dc-article">
                                        <figure class="dc-articleimg">
                                            <img src="<?= base_url('assets') ?>/images/articles/img-01.jpg" alt="img description">
                                            <figcaption>
                                                <div class="dc-articlesdocinfo">
                                                    <img src="<?= base_url('assets') ?>/images/articles/user/img-01.jpg" alt="img description">
                                ...
                                <div class="col-12 col-sm-12 col-md-6 col-lg-4 float-left">
                                    <div class="dc-article">
                                        <figure class="dc-articleimg">
                                            <img src="<?= base_url('assets') ?>/images/articles/img-02.jpg" alt="img description">
                                            <figcaption>
                                                <div class="dc-articlesdocinfo">
                                                    <img src="<?= base_url('assets') ?>/images/articles/user/img-02.jpg" alt="img description">
                                                    <span>Lincoln Claggett</span>
                                                </div>
                                            </figcaption>
                                        </figure>
                                ...
                                <div class="col-12 col-sm-12 col-md-6 col-lg-4 float-left">
                                    <div class="dc-article">
                                        <figure class="dc-articleimg">
                                            <img src="<?= base_url('assets') ?>/images/articles/img-03.jpg" alt="img description">
                                            <figcaption>
                                                <div class="dc-articlesdocinfo">
                                                    <img src="<?= base_url('assets') ?>/images/articles/user/img-03.jpg" alt="img description">
                                                    <span>Lincoln Claggett</span>
                                                </div>
                                            </figcaption>
                                        </figure>
                                ...
                                <div class="dc-footer-call-email">
                                    <div class="dc-callinfoholder">
                                        <figure class="dc-callinfoimg">
                                            <img src="<?= base_url('assets') ?>/images/footer/img-01.png" alt="img description">
                                        </figure>
                                    ...
                                    <div class="dc-callinfoholder dc-mailinfoholder">
                                        <figure class="dc-callinfoimg">
                                            <img src="<?= base_url('assets') ?>/images/footer/img-02.png" alt="img description">
                                        </figure>
                                        <div class="dc-callinfocontent">
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 float-left">
                                <div class="dc-fcol dc-widgetcontactus">
                                    <strong class="dc-logofooter"><a href="index.html"><img src="<?= base_url('assets') ?>/images/flogo.png" alt="company logo here"></a></strong>
                                        ...
                                        <ul class="dc-livefeeddetails">
                                            <li>
                                                <figure class="dc-latestadimg">
                                                    <img src="<?= base_url('assets') ?>/images/footer/img-03.png" alt="img description">
                                                </figure>
                                            ...
                                            <li>
                                                <figure class="dc-latestadimg">
                                                    <img src="<?= base_url('assets') ?>/images/footer/img-04.png" alt="img description">
                                                </figure>
                                                <div class="dc-latestadcontent">
                                ...
                                <div class="dc-fcol dc-newsletterholder">
                                    ...
                                    <div class="dc-footercontent dc-newsletterholder">
                                        ...
                                        <div class="dc-footerapps">
                                            ...
                                            <ul class="dc-btnapps">
                                                <li><a href="javascript:void(0)"><img src="<?= base_url('assets') ?>/images/footer/img-05.png" alt="img description"></a></li>
                                                <li><a href="javascript:void(0)"><img src="<?= base_url('assets') ?>/images/footer/img-06.png" alt="img description"></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="dc-modalcontent modal-content">
                    <div class="dc-popuptitle">
                        <h3>Give Category to Your Query</h3>
                        <a href="javascript;void(0);" class="dc-closebtn close"><i class="lnr lnr-cross" data-dismiss="modal" aria-label="Close"></i></a>
                    </div>
                    <div class="modal-body">
                        <form class="dc-formtheme dc-formhelp">
                            <fieldset>
                                <div class="form-group">
                                    <span class="dc-select">
                                        <select data-placeholder="Select Category*" name="Category*">
                                            <option value="Country">Select services Category*</option>
                                            <option value="Country">Cosmetic Surgeon</option>
                                            <option value="Country">Eye Specialist</option>
                                            <option value="Country">Gastroenterologist</option>
                                            <option value="Category">General Physician</option>
                                        </select>
                                    </span>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group dc-btnarea">
                                    <a href="javascript:void(0);" class="dc-btn">Ask Free Query</a>
                                </div>
                            </fieldset>
                        </form>
                    </div>
